...
void mininum(int grades[][EXAMS], int pupils, int tests);
void maxinum(int grades[][EXAMS], int pupils, int tests);
...
int main() {
	void(*processGrades[4])(int[][EXAMS], int, int)
		= { printArray,mininum,maxinum,average };
	int choice = 0;
...
void printMenu(void) {
	printf("\n\tEnter a choice:\n"
		...
		"\t  1  Find the mininum grade\n"
		"\t  2  Find the maxinum grade\n"
